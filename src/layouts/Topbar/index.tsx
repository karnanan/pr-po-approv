...
// images
import logoSm from '../../assets/images/logo-mih.png';
import avatar1 from '../../assets/images/users/user-1.jpg';
import logoDark from '../../assets/images/logo_sticky.png';
import logoLight from '../../assets/images/logo_sticky.png';
            ...
            <div className={containerClass}>
                ...
                <div className="logo-box">
                    ...
                    <Link to="/" className="logo logo-light text-center">
                        ...
                        <span className="logo-lg">
                            <img src={logoLight} alt="logo-light" height="42" />
                        </span>
                    </Link>
                </div>
